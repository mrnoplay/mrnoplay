      ...
      <div id="main" style="-webkit-app-region: no-drag">
        ...
        <div class="tutorialboard border">
          <div class="on-notbtn tutorial">
            ...
            <div v-if="page == 2">
              <img
                src="@/assets/img/tutorial/tutorial-start-en.png"
                id="gameicon"
                v-if="lang == 'en'"
              />
              <img
                src="@/assets/img/tutorial/tutorial-start-cn.png"
                id="gameicon"
                v-if="lang == 'cn'"
              />
            ...
            <div v-if="page == 3">
              <img
                src="@/assets/img/tutorial/tutorial-stop-en.png"
                id="gameicon"
                v-if="lang == 'en'"
              />
              <img
                src="@/assets/img/tutorial/tutorial-stop-cn.png"
                id="gameicon"
                v-if="lang == 'cn'"
              />
              ...
              <div class="pagetext">
                {{ $t('tut.3.2') }}
                <span class="red">{{ $t('tut.3.3') }}</span>
                {{ $t('tut.3.4') }}
              </div>
            </div>
            <div v-if="page == 4">
              <img
                src="@/assets/img/tutorial/tutorial-over-en.png"
                id="gameicon"
                v-if="lang == 'en'"
              />
              <img
                src="@/assets/img/tutorial/tutorial-over-cn.png"
                id="gameicon"
                v-if="lang == 'cn'"
              />
            ...
            <div v-if="page == 5">
              ...
              <img
                src="@/assets/img/tutorial/tutorial-mactray.png"
                id="gameicon-page1-page6"
              />
              ...
              <small
                ...
                class="new largebtn-notbtn transparent small red tutorial-a"
                @click="settings"
              >
                {{ $t("tostartonlogin") }}
                <br />
        ...
        >
          <div class="largebtn-innertext">{{ nexttext }}</div>
        </b-btn>
        <div>
          <b-btn
            variant="light"
